...
func (c *Commands) Dispatch(args []string) {
	...
	if len(args) > 0 {
		c.filterCommands(args, func(o *NamespaceCommand, info CommandInfo) bool {
...
func (c *Commands) filterCommands(args []string, foreach func(namespace *NamespaceCommand, info CommandInfo) bool) {
